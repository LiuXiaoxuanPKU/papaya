...
def plot(hardware, network):
    util_dir = f"benchmarks/{NET_TO_FOLER[network]}/{hardware}/results/utilization.json"
...
if __name__ == "__main__": 
    hardware = 'v100'
    networks = ['resnet50', 'wide_resnet50_2', 'bert-large-cased', 'transformer_lm_gpt3_small']
    for net in networks:
        plot(hardware, net)