...
def network_to_command(network):
    return "python3 train.py --data ~/dataset/imagenet --arch ARCH --batch-size BS CONFIG".replace("ARCH", network)
...
if __name__ == "__main__":
    ...
    if args.mode == 'linear_scan':
        ...
        batch_sizes = list(range(4, 32, 4)) + list(range(32, 256, 16)) + list(range(256, 1280, 32))
