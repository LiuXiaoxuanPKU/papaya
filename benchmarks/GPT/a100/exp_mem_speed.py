...
from fairseq.gact_utils import exp_recorder
...
if __name__ == "__main__":
    ...
    networks = args.network if args.network else ["transformer_lm_gpt3_xl"] #["transformer_lm_gpt3_medium","transformer_lm_gpt3_large"]#
    # algs = [None, "ckpt", "L1"]
    algs = ["ckpt",None]
    # algs = ["cpu-off"]
    actnn_level = None
